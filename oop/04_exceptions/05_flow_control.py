# Приложение для компании, которая продает виджеты и гаджеты. Когда клиент совершает покупку, товар может быть либо доступен, в этом случае товар удаляется из инвентаря и возвращается количество оставшихся товаров, либо его может не быть в наличии.
class ItemType:
